...
\item Do not use generative AI (such as ChatGPT) for the article
  summaries or other written assignments.
  \ei
...
\item Do not use generative AI (such as ChatGPT)
...
\item If we need to move online (or hybrid), there is a zoom link at
  the \href{https://canvas.wisc.edu/courses/529564}{Canvas site} for the course
  \ei
...
\item I'll post PDFs on the \href{https://canvas.wisc.edu/courses/529564}{Canvas site}
